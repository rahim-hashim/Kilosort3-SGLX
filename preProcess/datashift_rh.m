function rez = datashift_rh(rez, do_correction, figName, figPath)
...
if getOr(ops, 'fig', 1)  
    ...
    drawnow
    % save figure
    saveas(gcf, fullfile(figPath, [figName '_drift_trace.png']))
    ...
    % save figure
    saveas(gcf, fullfile(figPath, [figName '_drift_map.png']))
end
%%
% convert to um 
dshift = imin * dd;
